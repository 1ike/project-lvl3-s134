...
/* There are tests rely on the live web-server (inputURL),
they are not fo production, just for fun.
So you`ll might be need to correct "outputFixture"
in according with current server (and outer resources) state. */
